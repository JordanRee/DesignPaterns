...
namespace DIContainer.Extentions
{
    ...
    public static class ServiceCollectionExtention
    {
        ...
        /// <returns>Return the <see cref="ServiceCollection"/> given.</returns>
        ...
        /// <summary>
        /// Add new <typeparamref name="T"/> implementation type to the <paramref name="collection"/> as Singleton with the <paramref name="factory"/> provided.
        /// </summary>
        /// <typeparam name="T">Implementation type wanted.</typeparam>
        /// <param name="collection"><see cref="ServiceCollection"/> to add the implementation type in.</param>
        /// <param name="factory"><typeparamref name="T"/> factory to use.</param>
        /// <returns>Return the <see cref="ServiceCollection"/> given.</returns>
        public static ServiceCollection AddSingleton<T>(this ServiceCollection collection, Func<ServiceProvider, T> factory)
            where T : class
        {
            collection.Add(ServiceDescriptor.CreateSingleton(factory));
        ...
        /// <summary>
        /// Add new <typeparamref name="T"/> implementation type to the <paramref name="collection"/> as Scoped with the <paramref name="factory"/> provided.
        /// </summary>
        /// <typeparam name="T">Implementation type wanted.</typeparam>
        /// <param name="collection"><see cref="ServiceCollection"/> to add the implementation type in.</param>
        /// <param name="factory"><typeparamref name="T"/> factory to use.</param>
        /// <returns>Return the <see cref="ServiceCollection"/> given.</returns>
        public static ServiceCollection AddScoped<T>(this ServiceCollection collection, Func<ServiceProvider, T> factory)
            where T : class
        {
            collection.Add(ServiceDescriptor.CreateScoped(factory));
        ...
        /// <summary>
        /// Add new <typeparamref name="T"/> implementation type to the <paramref name="collection"/> as Transient with the <paramref name="factory"/> provided.
        /// </summary>
        /// <typeparam name="T">Implementation type wanted.</typeparam>
        /// <param name="collection"><see cref="ServiceCollection"/> to add the implementation type in.</param>
        /// <param name="factory"><typeparamref name="T"/> factory to use.</param>
        /// <returns>Return the <see cref="ServiceCollection"/> given.</returns>
        public static ServiceCollection AddTransient<T>(this ServiceCollection collection, Func<ServiceProvider, T> factory)
            where T : class
        {
            collection.Add(ServiceDescriptor.CreateTransient(factory));
