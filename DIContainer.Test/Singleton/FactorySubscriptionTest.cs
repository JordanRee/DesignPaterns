...
namespace DIContainer.Test.Singleton
{
    ...
    public class FactorySubscriptionTest : SingletonBase
    {
        [Test]
        public override void AddSingletonToCollection()
        {
            ...
            _ = collection.AddSingleton((s) => new SimpleTestingObject());
        ...
        public override void AddMultipleSingletonToCollection()
        {
            ...
            _ = collection.AddSingleton((s) => new SimpleTestingObject());
            _ = collection.AddSingleton((s) => new ClassParameterTestingObject(s.GetService<SimpleTestingObject>()));
